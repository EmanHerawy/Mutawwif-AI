import type { ProphetEntry } from '../types/prophet.types';
...
export const PROPHET_ENTRIES: ProphetEntry[] = [
  ...
  // ─── daily_life ──────────────────────────────────────────────────────────
  {
    ...
    textEn:
      'Ka\'b ibn Malik (may Allah be pleased with him) said: The Messenger of Allah ﷺ used to eat with three fingers and would not wipe his hand until he had licked it.',
    citationAr: 'رواه مسلم — كتاب الأشربة، باب استحباب لعق الأصابع (٢٠٣٢)',
    citationEn: 'Sahih Muslim — Book of Drinks, #2032',
    source: 'muslim',
    reviewedBy: 'MH',
  },
  {
  ...
  },
  {
    ...
    textEn:
      'Al-Bara\' ibn \'Azib (may Allah be pleased with him) reported that the Prophet ﷺ said: "When you go to your bed, perform wudu as you do for prayer, then lie on your right side and say: O Allah, I have submitted myself to You, turned my face to You, entrusted my affairs to You, and taken refuge with You..."',
    citationAr: 'رواه البخاري — كتاب الوضوء (٢٤٧)',
    citationEn: 'Sahih Al-Bukhari — Book of Purification, #247',
    source: 'bukhari',
    reviewedBy: 'MH',
  },
  {
  ...
  // ─── worship ─────────────────────────────────────────────────────────────
  {
    ...
    textEn:
      'Al-Mughirah ibn Shu\'bah (may Allah be pleased with him) said: The Prophet ﷺ would stand in prayer until his feet or legs swelled. When this was mentioned to him, he said: "Should I not be a grateful servant?"',
    citationAr: 'متفق عليه — رواه البخاري (١١٣٠) ومسلم (٢٨١٩)',
    citationEn: 'Agreed upon — Sahih Al-Bukhari #1130 and Sahih Muslim #2819',
    source: 'bukhari',
    reviewedBy: 'MH',
  },
  {
  ...
  // ─── mercy ───────────────────────────────────────────────────────────────
  {
    id: 'mr-01',
    category: 'mercy',
    titleAr: 'أُرسِل رحمةً للعالمين ﷺ',
    titleEn: 'Sent as a Mercy to All the Worlds ﷺ',
    textAr:
      'قال الله تعالى: {وَمَا أَرْسَلْنَاكَ إِلَّا رَحْمَةً لِّلْعَالَمِينَ} [الأنبياء: ١٠٧]. وعن أبي هريرة رضي الله عنه قال: قيل: يا رسول الله، ادعُ على المشركين، قال: "إني لم أُبعث لعّاناً، وإنما بُعثت رحمة".',
    textEn:
      'Allah Most High said: {And We have not sent you except as a mercy to all the worlds} [Al-Anbiya: 107]. Abu Hurayrah (may Allah be pleased with him) reported: It was said, "O Messenger of Allah, invoke a curse upon the polytheists." He replied: "I was not sent as one who curses. I was sent only as a mercy."',
    citationAr: 'القرآن الكريم — الأنبياء: ١٠٧؛ رواه مسلم (٢٥٩٩)',
    citationEn: 'Quran — Al-Anbiya: 107; Sahih Muslim #2599',
    source: 'muslim',
    reviewedBy: 'MH',
  },
  {
  ...
  },
  {
    id: 'fm-02',
    category: 'family',
    titleAr: 'فاطمة بضعة مني ﷺ',
    titleEn: '"Fatima Is a Part of Me" ﷺ',
    textAr:
      'قال رسول الله ﷺ: "فاطمة بضعة مني، فمن أغضبها أغضبني".',
    textEn:
      'The Messenger of Allah ﷺ said: "Fatima is a part of me. Whoever angers her angers me."',
    citationAr: 'متفق عليه — رواه البخاري (٣٧١٤) ومسلم (٢٤٤٩)',
    citationEn: 'Agreed upon — Sahih Al-Bukhari #3714 and Sahih Muslim #2449',
    source: 'bukhari',
    reviewedBy: 'MH',
  },
  {
  ...
  // ─── names_titles ─────────────────────────────────────────────────────────
  {
    ...
    titleAr: 'أسماؤه الخمسة ﷺ',
    titleEn: 'His Five Names ﷺ',
    textAr:
      'قال رسول الله ﷺ: "إن لي أسماء: أنا محمد، وأنا أحمد، وأنا الماحي الذي يَمحو الله بي الكفر، وأنا الحاشر الذي يُحشر الناس على قدمي، وأنا العاقب".',
    textEn:
      'The Messenger of Allah ﷺ said: "I have names: I am Muhammad; I am Ahmad; I am Al-Mahi (the Effacer), through whom Allah effaces disbelief; I am Al-Hashir (the Gatherer), before whose feet people will be gathered; and I am Al-\'Aqib (the Last)."',
    citationAr: 'متفق عليه — رواه البخاري (٣٥٣٢) ومسلم (٢٣٥٤)',
    citationEn: 'Agreed upon — Sahih Al-Bukhari #3532 and Sahih Muslim #2354',
    source: 'bukhari',
    reviewedBy: 'MH',
  },
  {
  ...
  },
  {
    ...
    textAr:
      'كانت قريش تلقِّب رسول الله ﷺ بالأمين قبل أن يُبعث نبياً، لِما عُرف عنه من الصدق والأمانة وحسن المعاملة. وكانوا يحتكمون إليه في خلافاتهم لثقتهم بعدله.',
    textEn:
      'The Quraysh used to call the Messenger of Allah ﷺ "Al-Amin" (The Trustworthy) before his prophethood, on account of his renowned truthfulness, trustworthiness, and fine conduct. They would refer their disputes to him because of their trust in his justice.',
    citationAr: 'ذكره ابن هشام في السيرة النبوية — باب صفاته ﷺ قبل البعثة',
    citationEn: 'Ibn Hisham — Al-Sirah Al-Nabawiyyah — Chapter on His Attributes Before Prophethood',
    source: 'ibn_hisham',
    reviewedBy: 'MH',
  },
  {
