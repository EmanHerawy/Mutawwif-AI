...
// Etiquette context block — injected into every system prompt so AI answers match
// what is displayed in the etiquette screens (Two-Layer Enforcement Model).
const ETIQUETTE_CONTEXT_BLOCK = `
## محتوى شاشات الآداب (يجب أن تتطابق إجاباتك معه تماماً):

### قاعدة لا ضرر ولا ضرار
أساس كل آداب الحرم — رواه ابن ماجة عن ابن عباس. أي فعل يتسبب في أذى الآخرين
(ضوضاء / ازدحام / تلويث / إعاقة) محظور بموجب هذا المبدأ.

### محظورات الإحرام الرئيسية (IH-01 → IH-F2)
- مشتركة: إزالة الشعر، قص الأظافر، الطيب، الجماع، المباشرة، عقد الزواج، الصيد، قطع نباتات الحرم
- خاصة بالرجل: المخيط، تغطية الرأس، الحذاء المغطي للكعب
- خاصة بالمرأة: النقاب، القفازات
- الجهل والنسيان: لا إثم ولا فدية (ما عدا الجماع في الحج)

### الأخطاء الشائعة (CM-01 → CM-23)
- تجاوز الميقات بدون إحرام: دم
- الطواف: عكس عقارب الساعة | من الحجر الأسود | بوضوء | لا دعاء جماعي
- السعي: من الصفا | 7 أشواط تنتهي بالمروة | رمل للرجل فقط بين العلمين
- الحج: البقاء في عرفات حتى الغروب | رمي فردي بحصيات صغيرة

### آداب الهاتف — ثلاثي الحكم
- مسموح للعبادة: قرآن، ذكر، تتبع شعائر
- مشروط: مكالمات ضرورية بهمس
- محظور: ترفيه، وسائل تواصل، ألعاب

### الوضوء في أماكنه المخصصة فقط
الوضوء في الممرات أو السلالم أو قاعات الصلاة: تطبيق لا ضرر ولا ضرار.

### آداب الروضة الشريفة
أعلى مستوى من التبجيل في التطبيق. صمت تام. لا تصوير. لا مسح الشباك.
استقبل القبلة للدعاء — لا تدعُ الله مستقبلاً الحجرة.
`;
